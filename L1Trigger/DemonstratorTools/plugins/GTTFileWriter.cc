...
void GTTFileWriter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.addUntracked<edm::InputTag>("selectedTracks", edm::InputTag("L1TrackSelectionProducer", "Level1TTTracksSelectedEmulation"));
  desc.addUntracked<edm::InputTag>("vertexAssociatedTracks", edm::InputTag("L1TrackSelectionProducer", "Level1TTTracksSelectedAssociatedEmulation"));
